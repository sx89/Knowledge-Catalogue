...
<!-- TOC -->autoauto- [1. 一 、基础概念](#1-一-基础概念)auto    - [1.1. 简介](#11-简介)auto    - [1.2. 工作原理](#12-工作原理)auto    - [1.3. 特点](#13-特点)auto- [2. 知识结构(接下来几章将按照本章顺序详细介绍各个知识点)](#2-知识结构接下来几章将按照本章顺序详细介绍各个知识点)auto    - [2.1. 请求报文(分为请求行,请求头,请求体)](#21-请求报文分为请求行请求头请求体)auto        - [2.1.1. 请求行(分为请求方法,URL,请求协议)](#211-请求行分为请求方法url请求协议)auto        - [2.1.2. 请求头(重要属性,比如content-type)](#212-请求头重要属性比如content-type)auto        - [2.1.3. 请求体](#213-请求体)auto    - [2.2. 响应报文](#22-响应报文)auto- [3. HTTP 方法](#3-http-方法)auto    - [3.1. GET](#31-get)auto    - [3.2. HEAD](#32-head)auto    - [3.3. POST](#33-post)auto    - [3.4. PUT](#34-put)auto    - [3.5. PATCH](#35-patch)auto    - [3.6. DELETE](#36-delete)auto    - [3.7. OPTIONS](#37-options)auto    - [3.8. CONNECT](#38-connect)auto    - [3.9. TRACE](#39-trace)auto- [4.GET 和 POST 比较](#4get-和-post-比较)auto    - [4.1. 作用](#41-作用)auto    - [4.2. 参数](#42-参数)auto    - [4.3. 安全](#43-安全)auto    - [4.4. 幂等性](#44-幂等性)auto    - [4.5. 可缓存](#45-可缓存)auto    - [4.6. XMLHttpRequest](#46-xmlhttprequest)auto    - [4.7. TCP底层的区别](#47-tcp底层的区别)auto- [5. URI](#5-uri)auto- [6. HTTP/2.0](#6-http20)auto    - [6.1. HTTP/1.x 缺陷](#61-http1x-缺陷)auto    - [6.2. 二进制分帧层](#62-二进制分帧层)auto    - [6.3. 服务端推送](#63-服务端推送)auto    - [6.4. 首部压缩](#64-首部压缩)auto    - [6.5. HTTP/1.1 新特性](#65-http11-新特性)auto- [7. HTTP 首部](#7-http-首部)auto    - [7.1. 通用首部字段](#71-通用首部字段)auto    - [7.2. 请求首部字段](#72-请求首部字段)auto    - [7.3. 响应首部字段](#73-响应首部字段)auto    - [7.4. 实体首部字段](#74-实体首部字段)auto- [8. 响应状态码](#8-响应状态码)auto    - [8.1. XX 信息](#81-xx-信息)auto    - [8.2. XX 成功](#82-xx-成功)auto    - [8.3. XX 重定向](#83-xx-重定向)auto    - [8.4. XX 客户端错误](#84-xx-客户端错误)auto    - [8.5. XX 服务器错误](#85-xx-服务器错误)auto- [9. 具体应用](#9-具体应用)auto    - [9.1. 连接管理](#91-连接管理)auto        - [9.1.1. 短连接与长连接](#911-短连接与长连接)auto        - [9.1.2. 流水线](#912-流水线)auto    - [9.2. Cookie](#92-cookie)auto        - [9.2.1. 用途](#921-用途)auto        - [9.2.2. 创建过程](#922-创建过程)auto        - [9.2.3. 分类](#923-分类)auto        - [9.2.4. 作用域](#924-作用域)auto        - [9.2.5. JavaScript](#925-javascript)auto        - [9.2.6. HttpOnly](#926-httponly)auto        - [9.2.7. Secure](#927-secure)auto        - [9.2.8. Session](#928-session)auto        - [9.2.9. 浏览器禁用 Cookie](#929-浏览器禁用-cookie)auto        - [9.2.10. Cookie 与 Session 选择](#9210-cookie-与-session-选择)auto    - [9.3. 缓存](#93-缓存)auto        - [9.3.1. 优点](#931-优点)auto        - [9.3.2. 实现方法](#932-实现方法)auto        - [9.3.3. Cache-Control](#933-cache-control)auto        - [9.3.4. 缓存验证](#934-缓存验证)auto    - [9.4. 内容协商](#94-内容协商)auto        - [9.4.1. 类型](#941-类型)auto        - [9.4.2. Vary](#942-vary)auto    - [9.5. 内容编码](#95-内容编码)auto    - [9.6. 范围请求](#96-范围请求)auto        - [9.6.1. Range](#961-range)auto        - [9.6.2. Accept-Ranges](#962-accept-ranges)auto        - [9.6.3. 响应状态码](#963-响应状态码)auto    - [9.7. 分块传输编码](#97-分块传输编码)auto    - [9.8. 多部分对象集合](#98-多部分对象集合)auto    - [9.9. 虚拟主机](#99-虚拟主机)auto    - [9.10. 通信数据转发](#910-通信数据转发)auto        - [9.10.1. 代理](#9101-代理)auto        - [9.10.2. 网关](#9102-网关)auto        - [9.10.3. 隧道](#9103-隧道)auto- [10. HTTPS](#10-https)auto    - [10.1. 加密](#101-加密)auto        - [10.1.1. 对称密钥加密](#1011-对称密钥加密)auto        - [10.1.2. 非对称密钥加密](#1012-非对称密钥加密)auto        - [10.1.3. HTTPS 采用的加密方式](#1013-https-采用的加密方式)auto    - [10.2. 认证](#102-认证)auto    - [10.3. 完整性保护](#103-完整性保护)auto    - [10.4. HTTPS 的缺点](#104-https-的缺点)autoauto<!-- /TOC -->
